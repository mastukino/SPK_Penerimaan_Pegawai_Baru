                        ...
                        <table class="table table-bordered " width="100%" cellspacing="0">
                            ...
                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              ...
                              $nama_lowongan=$data_lowongan['nama'];
                                ...
                                $test = $user_data['kode_penilaian']; 
                                echo "<tr>";
                                echo "<td hidden>".$user_data['id']."</td>";
                                echo "<td> <h6>".$user_data['kode_penilaian']."</h6></td>";
                                 echo "<td> <h6> 
                                <a href='penilaian-detail.php?kode_pelamar=$user_data[kode_pelamar]' style='text-decoration: none;'>

                                ".$user_data['kode_pelamar']."</a></h6></td>";
                                echo "<td class='text-justify'><h6>".$user_data['nama']."</h6></td>"; 
                                echo "<td class='text-justify'><h6>".$user_data['tanggal_lamaran']."</h6></td>";
                                echo "<td> <h6>".$user_data['kode_lowongan']." - ".$nama_lowongan."</h6> </td>"; 
                                echo "<td> <h6>".number_format($user_data['hasil'], 0, ',', '.')."</h6> </td>"; 


                                echo "<td class='text-center'> <a href='interview-tambah.php?id=$user_data[id]' style='text-decoration: none; '><i class='material-icons fas fa-address-card'  title='Interview $test'></i></a>

                       

                                | <a data-id='1' class='hapus' href='penilaian-delete.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>
