              ...
              <!--kolom isian table-->
                  ...
                  <td>Lowongan</td>
                    ...
                    <td><input class="form-control" type="date" readonly name="tanggal_lamaran" value="<?php echo $tanggal_lamaran;?>"></td>
                              ...
                              <?php
                        echo "<td class='text-center'><a href='interview-jawaban.php?kode_pelamar=$kode_pelamar'style='text-decoration:none; width:120px;' class='right waves-effect waves-light btn blue darken-2' >
                                Jawaban
                                </a></td>"
                        ?>
