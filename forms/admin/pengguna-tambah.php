   ...
   <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-user mr-1"></i>Pengguna</div>
                    <div class="card-body">
      ...
      <div class="row container">
        ...
        <form action="" method="post" name="form1">
            ...
            <table class="highlight">
              ...
              <tr>
                      <th>Username</th>
                      <th><input type="text" name="username" required maxlength="50"></th>
                    </tr>
                    <tr>
                      <th>Password</th>
                      <th><input type="password" name="password" required maxlength="50"></th>
                    </tr>
                     <tr>
                      <th>Konfirmasi Password</th>
                      <th><input type="password" name="konfirmasi_password" required maxlength="50"></th>
                    </tr>
                    <tr>
                      <th>Nama Pengguna</th>
                      <th><input type="text" name="nama_pengguna" required maxlength="50"></th>
                    </tr>               
                    <tr>
                      <th>Email</th>
                      <th><input type="text" name="email" required maxlength="50"></th>
                    </tr>
                    <tr>
            </table>
            <table>
                    <tr>
                      <th>
                        <input type="submit" name="tambah" value="Tambah User" class="right waves-effect waves-light btn blue darken-2" style="float: left;">
                      </th>
                      <th style="width: 1%;">
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
			...
			$cek_user=mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pengguna WHERE username='$_POST[username]'"));
			if ($cek_user > 0) {
			        echo '<script language="javascript">
			              alert ("User Sudah Ada Yang Menggunakan");</script>';
			              exit();
			}
            ...
            $result = mysqli_query($koneksi, "INSERT INTO pengguna(username,password,nama_pengguna,email) VALUES('$username','$password','$nama_pengguna','$email')");
