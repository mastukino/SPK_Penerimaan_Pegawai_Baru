...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE lowongankerja SET kode_lowongan='$kode_lowongan',nama='$nama',deskripsi='$deskripsi',persyaratan='$persyaratan' WHERE id=$id");
      ...
      <div class="row container">
        ...
        <form action="" method="post" name="form1">
            ...
            <table class="highlight">
              ...
              <tr>
                    <th>kode_lowongan</th>
                    <th><input type="text" name="kode_lowongan" readonly value=<?php echo $kode_lowongan; ?>></th>
                  </tr>
                  <tr> 
                    <td>Nama Lowongan Kerja</td>
                    <td><textarea style="height:50px;" name="nama" rows="1" ><?php echo $nama;?>
                    </textarea></td>
                  </tr>
                  <tr> 
                    <td>deskripsi</td>
                    <td><textarea style="height:200px;" name="deskripsi" rows="1" ><?php echo $deskripsi;?>
                    </textarea></td>
                  </tr>
                  <tr> 
                    <tr> 
                    <td>persyaratan</td>
                    <td><textarea style="height:200px;" name="persyaratan" rows="1" ><?php echo $persyaratan;?>
                    </textarea></td>
                  </tr>
                  <tr> 
                   <tr>
