        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
             ...
             <div class="row container">
                        ...
                        <form name="cari" method="post" action="kriteria-cari.php" class="row">
                            <div class="col-2">
                            ...
                            <div class="col-1">
                                <a href='kriteria.php' class="btn red">Kembali<i class="material-icons right"></i></a>
                            </div>
                         </form>

                            <div class="col-8"><div class="float-right">
                                <a href='kriteria-eksport.php' class="waves-effect waves-light btn blue darken-2">Export</a>
                                <a href='kriteria-tambah.php' class="btn btn-dark ">Tambah Baru</a>
                                 <a href='kriteria.php' class="waves-effect waves-light btn blue darken-2">Refresh<i class="material-icons right"></i></a>
                                </div>
                            </div>
                    ...
                    <!--table-->
                       ...
                       <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                          ...
                          $sql = "SELECT * FROM kriteria WHERE id LIKE '%$cari%' OR kode_kriteria LIKE '%$cari%' OR kode_lowongan LIKE '%$cari%' OR nama_kriteria LIKE '%$cari%' OR bobot LIKE '%$cari%'";
                          $query = mysqli_query($conn,$sql);
                           ...
                           if ($query->num_rows > 0) {
                            ...
                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              ...
                              $test = $data['kode_kriteria'];
                              echo "<tr>";
                              echo "<td hidden>".$data['id']."</td>";
                              echo "<td><h6>".$data['kode_kriteria']."</h6></td>";
                              echo "<td hidden><h6>".$data['kode_lowongan']."</h6></td>";

                              echo "<td> <h6>".$nama_lowongan."</h6> </td>";

                              echo "<td><h6>".$data['nama_kriteria']."</h6></td>";
                              echo "<td><h6>".$data['bobot']."</h6></td>";
                             
                            
                              echo "<td class='text-center'>  <a href='kriteria-edit.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='kriteria-delete.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>";
                              echo "<tr>";
                             } } 
