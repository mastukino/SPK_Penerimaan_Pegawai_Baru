...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE datapelamar SET kode_pelamar='$kode_pelamar',nama='$nama',tanggal_lahir='$tanggal_lahir',jenis_kelamin='$jenis_kelamin',alamat='$alamat',no_telpon='$no_telpon',email='$email',kode_lowongan='$kode_lowongan',tanggal_lamaran='$tanggal_lamaran',link='$link' WHERE id=$id");
   ...
   <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-briefcase mr-1"></i>Data Pelamar</div>
                    <div class="card-body">
        ...
        <form action="" method="post" name="form1">
            ...
            <table class="highlight">
              <!--kolom isian table-->
                  ...
                  <tr> 
                    <td>Nama Lengkap</td>
                    <td><textarea  rows="1"  type="text" class="form-control" name="nama" required maxlength="100"><?php echo $nama; ?></textarea></td>
                  </tr>
                  <tr> 
                    <td>Tanggal Lahir</td>
                    <td><input class="form-control" type="date" name="tanggal_lahir" value="<?php echo $tanggal_lahir;?>"></td>
                  </tr>
                  <tr> 
                    <tr> 
                    <td>Jenis Kelamin</td>
                  ...
                  <tr> 
                    <td>Alamat</td>
                    <td><textarea  rows="2"  type="text" class="form-control" name="alamat" required maxlength="100"><?php echo $alamat; ?></textarea></td>
                  </tr>
                  <tr> 
                    <td>No Telpon</td>
                    <td><input type="text" class="form-control" name="no_telpon" value=<?php echo $no_telpon; ?> required maxlength="15"></td>
                  </tr>
                  <tr> 
                    <td>Email</td>
                    <td><input type="text" class="form-control" name="email" value=<?php echo $email; ?> required maxlength="50"></td>
                  </tr>

                  <tr> 
                    <td>Link Website CV / Resume</td>
                    <td><input type="text" class="form-control" name="link"  required maxlength="1000" placeholder="e.g. Google Drive/ Linkedin/ Github/ Design Profile " value=<?php echo $link; ?>></td>
                  </tr>
                  <td>Lowongan</td>
                    <td>
                      <select class="form-control" name="kode_lowongan" required readonly  >      
                  ...
                  <table>
                    <tr>
                      <th>
                        <input type="submit" name="update" value="Ubah" class="right waves-effect waves-light btn blue darken-2" style="float: left;">
                      </th>
                      <th style="width: 1%;">
