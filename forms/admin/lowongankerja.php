                   ...
                   <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                            ...
                            while($user_data = mysqli_fetch_array($result)) { 
                                ...
                                echo "<td> <h6>".$user_data['kode_lowongan']."</h6></td>";
                                echo "<td> <h6>".$user_data['nama']."</h6> </td>";
                                echo "<td class='text-justify'><h6>".$user_data['deskripsi']."</h6></td>"; 
                                echo "<td class='text-justify'><h6>".$user_data['persyaratan']."</h6></td>"; 


                                echo "<td class='text-center'> <a href='lowongankerja-edit.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> 

                                | <a data-id='1' class='hapus' href='lowongankerja-delete.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>";
                            }
