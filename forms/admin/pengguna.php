                   ...
                   <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                            ...
                            while($user_data = mysqli_fetch_array($result)) { 
                                ...
                                echo "<td> <h6>".$user_data['username']."</h6></td>";
                                echo "<td> <h6>".$user_data['nama_pengguna']."</h6> </td>";
                                echo "<td><h6>".$user_data['email']."</h6></td>"; 


                                echo "<td class='text-center'> <a href='pengguna-edit.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> 

                                | <a data-id='1' class='hapus' href='pengguna-delete.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>";
                            }
