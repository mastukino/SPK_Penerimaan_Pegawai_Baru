...
// KODE OTOMATIS
$query = "SELECT max(kode_sub_kriteria) as maxKode FROM sub_kriteria";
$hasil = mysqli_query($koneksi, $query);
$data  = mysqli_fetch_array($hasil);
$kode_sub_kriteria = $data['maxKode'];
$noUrut = (int) substr($kode_sub_kriteria, 3, 3);
$noUrut++;
$char = "SK-";
...
<!--content-->
    <main>
        ...
        <form action="" method="post" name="form1">
            ...
            <table class="highlight">
              ...
              <tr>
                    ...
                    <th><input type="text" name="kode_sub_kriteria" readonly value="<?php echo $newID; ?>" ></th>
                  </tr>
                  ...
                  <td>Lowongan</td>
                    <td>
                      ...
                      <option value="" name="pilihanlistlowongan">Silahkan Pilih</option>                    
                  ...
                  <tr> 
                    <td>Nama Kriteria</td>
                    <td><input type="text" name="nama_sub_kriteria" ></td>
                  </tr>
                  <tr> 
                    <td>Nilai Altenatif</td>
                    <td><input type="text" name="nilai_altenatif"maxlength="1" onkeypress="return event.charCode >= 48 && event.charCode <=57" ></td>
                  </tr>
      ...
      $cek_user=mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM sub_kriteria WHERE kode_sub_kriteria='$_POST[kode_sub_kriteria]'"));
      if ($cek_user > 0) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO sub_kriteria(kode_sub_kriteria,kode_kriteria,kode_lowongan,nama_sub_kriteria,nilai_altenatif) VALUES('$kode_sub_kriteria','$kode_kriteria','$kode_lowongan','$nama_sub_kriteria','$nilai_altenatif')");
