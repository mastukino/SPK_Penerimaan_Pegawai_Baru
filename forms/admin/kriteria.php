                        ...
                        <table class="table table-bordered " width="100%" cellspacing="0">
                            ...
                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              ...
                              $nama_lowongan=$data_lowongan['nama'];
                                ...
                                echo "<td> <h6>".$user_data['kode_kriteria']."</h6></td>";
                                echo "<td hidden> <h6>".$user_data['kode_lowongan']."</h6> </td>";
                                echo "<td> <h6>".$nama_lowongan."</h6> </td>";
                                echo "<td><h6>".$user_data['nama_kriteria']."</h6></td>"; 
                                echo "<td> <h6>".$user_data['bobot']."</h6> </td>";
       




                                echo "<td class='text-center'> <a href='kriteria-edit.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> 

                                | <a data-id='1' class='hapus' href='kriteria-delete.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>";
