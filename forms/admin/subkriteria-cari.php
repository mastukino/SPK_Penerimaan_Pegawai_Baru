        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
             ...
             <div class="row container">
                        ...
                        <form name="cari" method="post" action="subkriteria-cari.php" class="row">
                            <div class="col-2">
                            ...
                            <div class="col-1">
                                <a href='subkriteria.php' class="btn red">Kembali<i class="material-icons right"></i></a>
                            </div>
                         </form>

                            <div class="col-8"><div class="float-right">
                                <a href='subkriteria-eksport.php' class="waves-effect waves-light btn blue darken-2">Export</a>
                                <a href='subkriteria-tambah.php' class="btn btn-dark ">Tambah Baru</a>
                                 <a href='subkriteria.php' class="waves-effect waves-light btn blue darken-2">Refresh<i class="material-icons right"></i></a>
                                </div>
                            </div>
                    ...
                    <!--table-->
                       ...
                       <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                          ...
                          <th hidden>Kode Kriteria</th>
                          <th>Nama Kriteria</th>
                          <th hidden>Kode Lowongan</th>
                          <th>Nama Lowongan</th>
                          ...
                          $sql = "SELECT * FROM sub_kriteria WHERE id LIKE '%$cari%' OR kode_sub_kriteria LIKE '%$cari%' OR kode_kriteria LIKE '%$cari%' OR kode_lowongan LIKE '%$cari%' OR nama_sub_kriteria LIKE '%$cari%' OR nilai_altenatif LIKE '%$cari%'";
                          $query = mysqli_query($conn,$sql);
                           ...
                           if ($query->num_rows > 0) {
                            ...
                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              ...
                              $kode_k = $data['kode_kriteria'];
                            $datalowongan = mysqli_query($koneksi, "SELECT * FROM kriteria WHERE kode_kriteria='$kode_k'");

                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              $kode_kriteria = $data_lowongan['kode_kriteria'];
                              $nama_kriteria=$data_lowongan['nama_kriteria'];
                            }
                              ...
                              $test = $data['kode_sub_kriteria'];

                            
                              echo "<tr>";
                              echo "<td hidden>".$data['id']."</td>";
                              echo "<td><h6>".$data['kode_sub_kriteria']."</h6></td>";
                              echo "<td hidden><h6>".$data['kode_kriteria']."</h6></td>";
                              echo "<td> <h6>".$nama_kriteria."</h6> </td>";
                              echo "<td hidden><h6>".$data['kode_lowongan']."</h6></td>";
                              echo "<td> <h6>".$nama_lowongan."</h6> </td>";
                              echo "<td><h6>".$data['nama_sub_kriteria']."</h6></td>";
                              echo "<td><h6>".$data['nilai_altenatif']."</h6></td>";
                             
                     
                            
                              echo "<td class='text-center'>  <a href='subkriteria-edit.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='subkriteria-delete.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>";
                              echo "<tr>";
                             } } 
