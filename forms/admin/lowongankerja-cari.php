        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
             ...
             <div class="row container">
                        ...
                        <form name="cari" method="post" action="lowongankerja-cari.php" class="row">
                            <div class="col-2">
                            ...
                            <div class="col-1">
                                <a href='lowongankerja.php' class="btn red">Kembali<i class="material-icons right"></i></a>
                            </div>
                         </form>

                            <div class="col-8"><div class="float-right">
                                <a href='lowongankerja-eksport.php' class="waves-effect waves-light btn blue darken-2">Export</a>
                                <a href='lowongankerja-tambah.php' class="btn btn-dark ">Tambah Baru</a>
                                 <a href='lowongankerja.php' class="waves-effect waves-light btn blue darken-2">Refresh<i class="material-icons right"></i></a>
                                </div>
                            </div>
                    ...
                    <!--table-->
                       ...
                       <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                          ...
                          $sql = "SELECT * FROM lowongankerja WHERE id LIKE '%$cari%' OR kode_lowongan LIKE '%$cari%' OR nama LIKE '%$cari%' OR deskripsi LIKE '%$cari%' OR persyaratan LIKE '%$cari%'";
                          $query = mysqli_query($conn,$sql);
                           ...
                           if ($query->num_rows > 0) {
                            while($data = mysqli_fetch_array($query)){
                              $test = $data['kode_lowongan'];

                            
                              echo "<tr>";
                              echo "<td hidden>".$data['id']."</td>";
                              echo "<td><h6>".$data['kode_lowongan']."</h6></td>";
                              echo "<td><h6>".$data['nama']."</h6></td>";
                              echo "<td class='text-justify'><h6>".$data['deskripsi']."</h6></td>";  
                              echo "<td class='text-justify'><h6>".$data['persyaratan']."</h6></td>"; 
                              echo "<td class='text-center'>  <a href='lowongankerja-edit.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='lowongankerja-delete.php?id=$data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>";
                              echo "<tr>";
                             } } 
