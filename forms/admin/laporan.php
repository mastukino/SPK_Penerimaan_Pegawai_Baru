   ...
   <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-chart-area mr-1"></i>Laporan</div>
                    <div class="card-body">
                   ...
                   <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                            ...
                            while($user_data = mysqli_fetch_array($result)) { 
                                ...
                                $test = $user_data['kode_laporan']; 
                                echo "<tr>";
                                echo "<td hidden>".$user_data['id']."</td>";
                                echo "<td> <h6>".$user_data['kode_laporan']."</h6></td>";
                                echo "<td> <h6>".$user_data['kode_interview']."</h6></td>";
                                 echo "<td> <h6> 
                                <a href='laporan-detail.php?kode_pelamar=$user_data[kode_pelamar]' style='text-decoration: none;'>
                                ...
                                echo "<td ><h6>".$user_data['nama_lowongan']."</h6></td>";
    
                                echo "<td> <h6>".number_format($user_data['hasil'], 0, ',', '.')."</h6> </td>"; 
                                echo "<td class='text-justify'><h6>".$user_data['status']."</h6></td>";


                                echo "<td><a data-id='1' class='hapus' href='laporan-delete.php?id=$user_data[id]&kode_interview=$user_data[kode_interview]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a></td>
