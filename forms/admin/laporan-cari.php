...
$result = mysqli_query($koneksi, "SELECT * FROM laporan ORDER BY hasil DESC");
   ...
   <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-star mr-1"></i>Laporan</div>
                    <div class="card-body">
            ...
            <div class="row container">
                        ...
                        <form name="cari" method="post" action="Laporan-cari.php" class="row">
                            <div class="col-2">
                          ...
                          <div class="col-1">
                                <a href='Laporan.php' class="btn red">Kembali<i class="material-icons right"></i></a>
                            </div>

                            <div class="col-8"><div class="float-right">
                                <a href='Laporan-eksport.php' class="waves-effect waves-light btn blue darken-2">Export</a>
                                <a href='interview.php' class="btn btn-dark ">Tambah Baru</a>
                                 <a href='Laporan.php' class="waves-effect waves-light btn blue darken-2">Refresh<i class="material-icons right"></i></a>
                                </div>
                            </div>
                ...
                <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                          ...
                          $sql = "SELECT * FROM laporan WHERE id LIKE '%$cari%' OR kode_laporan LIKE '%$cari%' OR kode_interview LIKE '%$cari%' OR kode_pelamar LIKE '%$cari%' OR nama LIKE '%$cari%' OR email LIKE '%$cari%' OR no_telpon LIKE '%$cari%' OR nama_lowongan LIKE '%$cari%' OR status LIKE '%$cari%' ORDER BY hasil DESC ";
                          $query = mysqli_query($conn,$sql);
                           ...
                           if ($query->num_rows > 0) {
                            while($data = mysqli_fetch_array($query)){
                               ...
                               $test = $data['kode_laporan']; 
                                echo "<tr>";
                                echo "<td hidden>".$data['id']."</td>";
                                echo "<td> <h6>".$data['kode_laporan']."</h6></td>";
                                echo "<td> <h6>".$data['kode_interview']."</h6></td>";
                                 echo "<td> <h6> 
                                <a href='laporan-detail.php?kode_pelamar=$data[kode_pelamar]' style='text-decoration: none;'>

                                ".$data['kode_pelamar']."</a></h6></td>";
                                echo "<td class='text-justify'><h6>".$data['nama']."</h6></td>"; 
                                echo "<td class='text-justify'><h6>".$data['email']."</h6></td>";
                                echo "<td class='text-justify'><h6>".$data['no_telpon']."</h6></td>";
                                echo "<td ><h6>".$data['nama_lowongan']."</h6></td>";
    
                                echo "<td> <h6>".number_format($data['hasil'], 0, ',', '.')."</h6> </td>"; 
                                echo "<td class='text-justify'><h6>".$data['status']."</h6></td>";


                                echo "<td><a data-id='1' class='hapus' href='laporan-delete.php?id=$data[id]&kode_interview=$data[kode_interview]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a></td>";
                             } } 
                              ...
                              echo "<tr><td colspan='10'><center><h6><b>'$substr'</b> Tidak Ditemukan. Silahkan Periksa Kembali Keyword Anda</h6></center></td></tr>";}
                          }
                      ?>
