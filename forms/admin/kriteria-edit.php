...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE kriteria SET kode_kriteria='$kode_kriteria',kode_lowongan='$kode_lowongan',nama_kriteria='$nama_kriteria',bobot='$bobot' WHERE id=$id");
...
while($user_data = mysqli_fetch_array($result))
{
  ...
  $nama_kriteria=$user_data['nama_kriteria'];
  $bobot=$user_data['bobot'];
      ...
      <div class="row container">
        ...
        <form action="" method="post" name="form1">
            ...
            <table class="highlight">
              ...
              <tr>
                    <th>Kode Kriteria</th>
                    <th><input type="text" name="kode_kriteria" readonly value=<?php echo $kode_kriteria; ?>></th>
                  </tr>
                  <td>Lowongan</td>
                    <td>
                  ...
                  <tr> 
                    <td>Nama Kriteria</td>
                    <td><textarea  rows="1"  type="text" name="nama_kriteria" ><?php echo $nama_kriteria;?></textarea></td>
                  </tr>
                  <tr> 
                    <td>Bobot</td>
                    <td><input type="text" name="bobot" value="<?php echo $bobot;?>" maxlength="1" onkeypress="return event.charCode >= 48 && event.charCode <=57" ></td>
                  </tr>
