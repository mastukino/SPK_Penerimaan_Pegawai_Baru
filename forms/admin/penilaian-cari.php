...
$result = mysqli_query($koneksi, "SELECT * FROM penilaian ORDER BY hasil DESC");
   ...
   <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-star mr-1"></i>Penilaian</div>
                    <div class="card-body">
            ...
            <div class="row container">
                        ...
                        <form name="cari" method="post" action="penilaian-cari.php" class="row">
                            <div class="col-2">
                          ...
                          <div class="col-1">
                                <a href='penilaian.php' class="btn red">Kembali<i class="material-icons right"></i></a>
                            </div>

                            <div class="col-8"><div class="float-right">
                                <a href='penilaian-eksport.php' class="waves-effect waves-light btn blue darken-2">Export</a>
                                <a href='datapelamar.php' class="btn btn-dark ">Tambah Baru</a>
                                 <a href='penilaian.php' class="waves-effect waves-light btn blue darken-2">Refresh<i class="material-icons right"></i></a>
                                </div>
                            </div>
                ...
                <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                          ...
                          $sql = "SELECT * FROM penilaian WHERE id LIKE '%$cari%' OR kode_penilaian LIKE '%$cari%' OR kode_pelamar LIKE '%$cari%' OR nama LIKE '%$cari%' OR tanggal_lamaran LIKE '%$cari%' OR kode_lowongan LIKE '%$cari%' ORDER BY hasil DESC ";
                          $query = mysqli_query($conn,$sql);
                           ...
                           if ($query->num_rows > 0) {
                            ...
                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              ...
                              $test = $data['kode_penilaian'];

                            
                              echo "<tr>";
                              echo "<td hidden>".$data['id']." </h6></td>";
                              echo "<td> <h6>".$data['kode_penilaian']." </h6></td>";
                              echo "<td> <h6> 
