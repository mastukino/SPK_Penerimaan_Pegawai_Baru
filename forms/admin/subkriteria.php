                   ...
                   <div class="table-responsive" >
                        <table class="table table-bordered " width="100%" cellspacing="0">
                            ...
                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              ...
                              $kode_k = $user_data['kode_kriteria'];
                            ...
                            while($data_lowongan = mysqli_fetch_array($datalowongan))
                            {
                              ...
                              $nama_kriteria=$data_lowongan['nama_kriteria'];
                                ...
                                $test = $user_data['kode_sub_kriteria']; 
                                echo "<tr>";
                                echo "<td hidden>".$user_data['id']."</td>";
                                echo "<td> <h6>".$user_data['kode_sub_kriteria']."</h6></td>";
                                ...
                                echo "<td><h6>".$user_data['nama_sub_kriteria']."</h6></td>"; 
                                echo "<td> <h6>".$user_data['nilai_altenatif']."</h6> </td>";
                      


                                echo "<td class='text-center'> <a href='subkriteria-edit.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> 

                                | <a data-id='1' class='hapus' href='subkriteria-delete.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a>";
                            }
