      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
            ...
            <article class="entry entry-single ">
                          ...
                          <p class="text-center" style="font-weight: bold;font-size: 30px; text-transform: capitalize;" ><?php echo $nama;?></p>
                        <hr>
                            <!--kolom header table-->
                        ...
                        <p style="font-weight: bold;font-size: 20px;"> Job Description:</p>
                        <p style="margin-left: 50px; width: 500px" class="text-justify"><?php echo $deskripsi;?></p>
                        <br>
                        <p style="font-weight: bold;font-size: 20px;"> Requirements:</p>
                        <p  style="margin-left: 50px; width: 500px ;" ><?php echo $persyaratan;?></p>
                        ...
                        echo "<td class='text-center'><a href='lowongan-form.php?id=$_GET[id]'style='text-decoration:none; width:160px' class='btn btn-primary'>
                                Kirim Lamaran
                                <i class='bi bi-arrow-right'></i></a>
                                </td> ";
                       echo "<td class='text-center'><a href='lowongan.php'style='text-decoration:none; width:160px;' class='btn btn-danger' >
                                Kembali
                                </a></td>";
